...
# Crea un menú desplegable (Combobox)
tickers = ["AAPL", "MSFT", "GOOGL", "AMZN", "TSLA", "FB", "BRK-A", "V", "JPM", "JNJ"]  # Lista predeterminada, se debe corregir codigo para descargar acciones mas transadas y actualizar lista de forma automatica
ticker_combobox = ttk.Combobox(root, values=tickers)
ticker_combobox.pack(pady=10)
ticker_combobox.set("CSCO")  # Valor por defecto

# Boton mostrar grafico
